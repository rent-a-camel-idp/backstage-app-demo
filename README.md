...
```shell
docker build . -t quay.io/rent-a-camel-idp/backstage:latest --no-cache
docker login quay.io/rent-a-camel-idp/backstage
docker push quay.io/rent-a-camel-idp/backstage:latest
```

note the images is already pushed to `ghcr.io/rent-a-camel-idp/backstage-app-demo:main`
